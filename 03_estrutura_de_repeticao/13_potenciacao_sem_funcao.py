...
def main():
    ...
    potencia = potenciacao_while(base, expoente)
    print(f'A base {base} elevada ao expoente {expoente} é igual a = {potencia}')
    
    base1 = int(input('Base: '))
    expoente1 = int(input('Expoente: '))
    potencia1 = potenciacao_for(base1, expoente1)
    print(f'A base {base} elevada ao expoente {expoente1} é igual a = {potencia1}')
